...
public class jdialog_LoaiSP extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lblMaLoai = new javax.swing.JTextField();
        jLabel2 = new javax.swing.JLabel();
        txtTenLoai = new javax.swing.JTextField();
        lblErorrTenLoai = new javax.swing.JLabel();
        ...
        lblMaLoai.setEditable(false);
        lblMaLoai.setBackground(new java.awt.Color(226, 232, 240));
        lblMaLoai.setText("1222");

        jLabel2.setText("Tên loại:");

        txtTenLoai.setBackground(new java.awt.Color(226, 232, 240));

        lblErorrTenLoai.setForeground(new java.awt.Color(255, 0, 51));
        lblErorrTenLoai.setText("Nhà cung cấp đang trống");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblErorrTenLoai, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(txtTenLoai, javax.swing.GroupLayout.PREFERRED_SIZE, 264, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 9, Short.MAX_VALUE))))
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                        .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(lblMaLoai, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(lblMaLoai, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel2)
                    .addComponent(txtTenLoai, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(lblErorrTenLoai)
                .addGap(88, 88, 88)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void tblListMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblListMouseClicked
        ...
        LoaiSP enity = thdao.selectByID(maNCC);
        setform(enity);
        insert = false;
        UpdateStatic();
    ...
    private javax.swing.JLabel lblErorrTenLoai;
    private javax.swing.JTextField lblMaLoai;
    private javax.swing.JTable tblList;
    private javax.swing.JTextField txtSearch;
    private javax.swing.JTextField txtTenLoai;
    // End of variables declaration//GEN-END:variables

    LoaiSPDAO thdao = new LoaiSPDAO();
    List<LoaiSP> list = new ArrayList<>();

    String colums[] = {"Mã loại", "Tên loại"};
    ...
    void clear() {
        ...
        LoaiSP ht = thdao.selecteTop1DESC();
        lblMaLoai.setText((ht.getMaLoai() + 1) + "");
        txtTenLoai.setText(null);
        lblErorrTenLoai.setVisible(false);
        insert = true;
        UpdateStatic();
    }
    ...
    void fillTable() {
        ...
        for (LoaiSP enity : list) {
            model.addRow(new Object[]{enity.getMaLoai(), enity.getTenLoai()});
        }
        tblList.setModel(model);
    }

    void setform(LoaiSP enity) {
        lblMaLoai.setText(enity.getMaLoai() + "");
        txtTenLoai.setText(enity.getTenLoai());
        lblErorrTenLoai.setVisible(false);
    }

    boolean checkNull() {
        if (txtTenLoai.getText().isBlank()) {
            lblErorrTenLoai.setText("Tên loại đang trống");
            lblErorrTenLoai.setVisible(true);
            return false;
        }
        return true;
    }
    ...
    int checkExitTenNCC(int ma) {
        ...
        list = thdao.selectAll();
        for (LoaiSP enity : list) {
            if (enity.getTenLoai().equalsIgnoreCase(txtTenLoai.getText()) && enity.getMaLoai() == ma) {
                i++;
            } else if (enity.getTenLoai().equalsIgnoreCase(txtTenLoai.getText()) && enity.getMaLoai() != ma) {
                i = i + 2;
            }
        }
        return i;
    ...
    void Insert() {
        if (checkNull()) {
            if (checkExitTenNCC(Integer.parseInt(lblMaLoai.getText())) == 0) {
                LoaiSP enity = new LoaiSP();
                enity.setMaLoai(Integer.parseInt(lblMaLoai.getText()));
                enity.setTenLoai(txtTenLoai.getText());
                thdao.insert(enity);
                ...
                this.showMessage("Tên loại đã tồn tại.");
            }
        } else {
    ...
    void Update() {
        if (checkNull()) {
            if (checkExitTenNCC(Integer.parseInt(lblMaLoai.getText())) <= 1) {
                LoaiSP enity = new LoaiSP();
                enity.setMaLoai(Integer.parseInt(lblMaLoai.getText()));
                enity.setTenLoai(txtTenLoai.getText());
                thdao.update(enity);
    ...
    void Delete() {
        try {
            if (this.showConfirm("Bạn thật sự muốn xóa?")) {
                thdao.delete(Integer.parseInt(lblMaLoai.getText()));
            ...
            this.showMessage("Loại đang hoạt động.");
        }
    }
